    ...
    <div className="app_hero">
      ...
      <div className="app__hero-wrapper flex_center">
        <div className="app_hero-wrapper_info">
          ...
          <button className="custom_button">Register</button></Slide>
      ...
      <img src={images.star} alt="gradient-top" className="absolute_star stars" />
      <img src={images.prestar} alt="gradient-top" className="absolute_star2 stars" />
    </div>
  );
}
